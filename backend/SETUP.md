...
Make sure your React frontend is running on http://localhost:3000 and it will automatically connect to the backend.
...
- **CORS errors**: Make sure frontend is running on the correct port 